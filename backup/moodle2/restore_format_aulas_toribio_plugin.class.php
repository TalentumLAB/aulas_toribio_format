...
/**
 * aulas_toribio_format Information
 *
 * @package    course/format
 * @subpackage aulas_toribio_format
...
/**
 * Provides the information to backup aulas_toribio_format course format
 */
class restore_format_aulas_toribio_plugin extends restore_format_plugin{ 
    ...
    protected function define_course_plugin_structure() {
        ...
        // only has a /aulas_toribio_format element).
        $elepath = $this->get_pathfor('/aulas_toribio_format');

        // The 'lazystudents' here defines that it will use the
        // process_lazystudents function to restore its element.
        $paths[] = new restore_path_element('aulas_toribio_format', $elepath);

        // return $paths;
        return [new restore_path_element('aulas_toribio_format', $this->get_pathfor('/aulas_toribio_format'))];
    }
    ...
    function after_execute_course() {
        ...
        $this->add_related_files('format_aulas_toribio_format', 'images', null);
    }

    /**
     * Process the 'lazystudents' element
     */
    public function process_aulas_toribio_format($data) {
        global $DB;

        // Get data record ready to insert in datameta
        $data = (object)$data;
