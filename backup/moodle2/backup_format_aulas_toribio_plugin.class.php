 ...
 */
class backup_format_aulas_toribio_plugin extends backup_format_plugin {

    protected function define_course_plugin_structure() {

        // Define the virtual plugin element with the condition to fulfill.
        $plugin = $this->get_plugin_element(null, '/course/format', 'aulas_toribio_format');
        ...
        $pluginwrapper->add_child($filesformat);
            ...
            $filesformat->annotate_files('format_aulas_toribio_format', 'images', null);
